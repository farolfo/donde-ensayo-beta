						...
						<div class="row-fluid" style="margin-bottom: 8px;">
                			<div style="margin-left: 0;" class="span12">
                                <c:choose>
                                        ...
                                        <c:otherwise>
                                        		<h5>Mostrando <c:out value="${fn:length(searchResultPlaces)}"/> profesor<c:if test="${fn:length(searchResultPlaces) gt 1}">es</c:if>: </h5>
                                            	...
                                            	<c:if test="${moreResultsPending}"><small ><a href="<c:url value='/bin/professor/searchNextResults?nextResults=${nextResults}'/>">Ver m&aacute;s resultados...</a></small></c:if>
                                        </c:otherwise>
                                </c:choose>
                        	</div>
                		</div>
